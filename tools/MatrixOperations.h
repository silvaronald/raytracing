...
inline Point3D pointMatrixMultiplication(float x, float y, float z, Matrix4X4 matrix){
    Point3D result;
...
inline Vector3D vectorMatrixMultiplication(float x, float y, float z, Matrix4X4 matrix){
    Vector3D result;
